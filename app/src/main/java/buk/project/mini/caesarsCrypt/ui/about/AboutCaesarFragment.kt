...
class AboutCaesarFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        aboutCaesarViewModel =
                ViewModelProvider(this).get(AboutCaesarViewModel::class.java)
        val root = inflater.inflate(R.layout.fragment_about_caesar, container, false)
        //val textView: TextView = root.findViewById(R.id.text_dashboard)

        aboutCaesarViewModel.text.observe(viewLifecycleOwner, {
            //textView.text = it
